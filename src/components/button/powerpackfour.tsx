...
<div className="flex flex-col items-center">
            <img
              src="https://res.cloudinary.com/divh5admv/image/upload/v1744747665/imagem_2025-04-15_210743695_gfo87j.png"
              alt="Power Pack x5"
        ...
        <div className="relative p-0.5 bg-gradient-to-r from-green-500 to-purple-500 rounded-lg mx-auto w-[280px] mt-2">
          <div className="bg-black p-2 rounded-lg">
            ...
            >
              POTENTIAL GAIN: £27.99 IN SLP VALUE
            </h2>
          </div>
        </div>

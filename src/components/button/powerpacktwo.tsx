...
<div className="flex flex-col items-center">
            <img
              src="https://res.cloudinary.com/divh5admv/image/upload/v1744747623/imagem_2025-04-15_210701307_rsyl5k.png"
              alt="Power Pack x5"
        ...
        <div className="relative p-0.5 bg-gradient-to-r from-green-500 to-purple-500 rounded-lg mx-auto w-[280px] mt-2">
          <div className="bg-black p-2 rounded-lg">
            ...
            >
              POTENTIAL GAIN: £13.49 IN SLP VALUE
            </h2>
          </div>
        </div>
